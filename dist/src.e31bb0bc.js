...
var ImageBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)("<img  class='img'src='".concat(this.value, "' alt='").concat(alt, "' style='").concat((0, _utils.css)(is), "'"), (0, _utils.css)(styles));
    }
  }]);
...
var model = [new _blocks.TitleBlock("Contstructor sites on Vanilla JS", {
  tag: "h2",
...
}), new _blocks.ColumnsBlock(["Javascript application on vanilla JavaScrapt code create by TakumiFuji from Kaliningrad", "JavaScript hero in this world", "JavaScript - it's simple and interesting!"], {
  styles: {
...
},{"./model":"model.js","./styles/style.css":"styles/style.css","./classes/app":"classes/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
